...
const navItems: NavItem[] = [
  {
    ...
    subItems: [
      ...
      { name: "Módulos", path: "/modules", pro: false },
      { name: "Permisos", path: "/permissions", pro: false },
      // { name: "Empresa", path: "/company", pro: false }
    ],
  },
  {
    icon: <ListIcon />,
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Materia Prima", path: "/materia-prima", pro: false },
      { name: "Ajuste de Inventario", path: "/ajuste-inventario", pro: false }
    ],
  },
  {
    icon: <PieChartIcon />,
